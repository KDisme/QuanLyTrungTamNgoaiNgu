// File này chỉ re-export để giữ tương thích ngược với các chỗ đang
// require('../services/homework.service'). Logic thật nằm trong ./homework/*.
module.exports = require('./homework/index');
