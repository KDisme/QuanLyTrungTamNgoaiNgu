...
// Định nghĩa Interface (Nên chuyển các interface này vào src/@types/index.ts)
...
const TeacherManagement: React.FC = () => {
    ...
    const fetchClasses = async () => {
        try {
            ...
            const classData = Array.isArray(res.data) ? res.data : res.data?.data || [];
                    ...
                    <table className="table">
                        ...
                        <tbody>
                            {filteredTeachers.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan={6} className="td-center py-10 text-muted">
                ...
                <div className="modal-overlay">
                    <div className="modal">
                        <div className="modal-head">
                            <h2 className="modal-title">{editingTeacher ? "Chỉnh sửa giáo viên" : "Thêm giáo viên"}</h2>
